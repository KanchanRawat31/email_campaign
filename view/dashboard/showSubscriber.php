...
<div class="container-fluid text-center">    
  ...
  //echo 'key does not exists';
    if(array_key_exists('subscribers',$this->view_data)){
     //echo 'key exists';
      $table = '<table border=2 class="table table-hover table-dark">';
      $table .='<tr>
              <th>id</th>
              <th>first_name</th>
              <th>last_name</th>
          ...
          foreach ($this->view_data['subscribers'] as $subscriber)
          {
            $subscriberInfo = explode('//',$subscriber);
            $table .='<tr>';
            foreach($subscriberInfo as $item)
            {
              $table .= '<td>'.$item.'</td>';
            }
            $table .= '</tr>';
